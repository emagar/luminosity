...
- Measures are being re-computed using INE's 2020 maps (instead of 2017 maps). Data for Aguascalientes through Michoacán, Baja California, Campeche (with new municipalities), Chiapas (new municipalities), and Veracruz ready; rest forthcoming, *stay tuned*. Comments, critiques, and suggestions welcome by email.
