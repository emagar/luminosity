...
##                                                                        ##
## Code to debug, validate, describe SECCIÓN electoral-level statistics   ##
##                                                                        ##
...
edon <- 15; edo <- edos[edon]; estado <- estados[edon]; print(paste("Will describe", toupper(estado), "stats"))

# secciones
dd <- c(paste0("~/Dropbox/data/mapas/luminosity/data/secciones/", edo, "/")) # secciones
